...
declare module '$env/static/private' {
	export const LANDBOT_CONFIG_URL: string;
...
declare module '$env/static/public' {
	export const PUBLIC_BORIS_CMS_URL: string;
...
declare module '$env/dynamic/public' {
	export const env: {
		PUBLIC_BORIS_CMS_URL: string;
		PUBLIC_GOOGLE_ANALYTICS_MEASUREMENT_ID: string;
