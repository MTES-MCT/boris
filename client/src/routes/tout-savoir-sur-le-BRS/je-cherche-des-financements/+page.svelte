...
<Section
  ...
  <h2>Les emprunts et aides disponibles</h2>
  ...
  <h2>Les frais à payer en tant que propriétaire en BRS</h2>
  <p class="fr-mb-0">
  ...
  <h2>L’achat d’un logement, une projection à plus long terme</h2>
  <p>
