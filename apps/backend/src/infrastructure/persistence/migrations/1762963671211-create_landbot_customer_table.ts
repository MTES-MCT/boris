...
export class CreateLandbotCustomerTable1762963671211
  implements MigrationInterface
{
  name = 'CreateLandbotCustomerTable1762963671211';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "landbot_customer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "eligibility" "public"."landbot_customer_eligibility_enum", "brsKnowledge" "public"."landbot_customer_brsknowledge_enum", "realEstateSituation" "public"."landbot_customer_realestatesituation_enum", "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "departementId" uuid, CONSTRAINT "PK_a5f8120f4a58259b52e21d9901c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
