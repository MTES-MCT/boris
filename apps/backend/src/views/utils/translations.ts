...
const translations: translations = {
  ...
  fields: {
    ...
    deliveryMonth: 'Mois de livraison',
  ...
  contents: {
    ...
    brsDiffusionWebsites: {
      ...
      columns: [
        ...
        { key: 'programName', label: 'Programme', type: 'string' },
        ...
        { key: 'housingType', label: 'Type', type: 'string' },
        { key: 'deliveryMonth', label: 'Livraison', type: 'string' },
        { key: 'id', label: 'Actions', type: 'actions' },
      ],
    },
